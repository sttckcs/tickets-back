...
const {register, login, getCurrentUser, changePermissions, editUser, editUserBilling, getAllUserEmails, getBillPDF, verifyUser, recoverPassword, changePassword, getUserById, sendEmail, sendRecoveryEmail, logout} = require('../controllers/User.controller')
